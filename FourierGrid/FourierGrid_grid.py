...
class DenseGrid(nn.Module):
    def __init__(self, channels, world_size, xyz_min, xyz_max, use_nerf_pos, **kwargs):
        ...
        # print('DenseGrid: channels={}, world_size={}, xyz_min={}, xyz_max={}'.format(channels, world_size, xyz_min, xyz_max))
    ...
    def forward(self, xyz):
        ...
        xyz: global coordinates to query
        '''
        # print('DenseGrid: channels={}, world_size={}, xyz_min={}, xyz_max={}'.format(self.channels, self.world_size, self.xyz_min, self.xyz_max))
        shape = xyz.shape[:-1]
        xyz = xyz.reshape(1,1,1,-1,3)
        ind_norm = ((xyz - self.xyz_min) / (self.xyz_max - self.xyz_min)).flip((-1,)) * 2 - 1
