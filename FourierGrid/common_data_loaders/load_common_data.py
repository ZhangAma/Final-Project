...
def load_common_data(args, cfg):

    K, depths = None, None
    near_clip = None

    if args.dataset_type == 'llff':
        images, edgeimages, depths, poses, bds, render_poses, i_test = load_llff_data(
                args.datadir, cfg.edgeType, args.factor, args.width, args.height,
        ...
        images, poses, render_poses, hwf, K, i_split, edgeimages = load_nerfpp_data(cfg, args.datadir, 
                                                                                   training_ids=training_ids)
        print('Loaded nerf_pp', images.shape, hwf, args.datadir) # [N, H, W, 3]
        print('Loaded edge images', edgeimages.shape) # [N, H, W, 1]
        i_train, i_val, i_test = i_split
    ...
    data_dict = dict(
        ...
        images=images, depths=depths, edgeimages=edgeimages,
