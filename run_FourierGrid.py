...
def config_parser():
    ...
    parser.add_argument("--edgeLoss", action='store_true', help='use edge loss')
    parser.add_argument("--edgeType", type=str, default='canny', help='edge type')
    parser.add_argument("--edgeTrainType", type=str, default='EdgeWeight', help='edge train type')
    parser.add_argument("--edgeRenderWeight", type=float, default=0.15, help='edge render weight')
...
if __name__=='__main__':
    ...
    cfg.expname = cfg.expname + args.exp_id + str(args.edgeLoss) + args.edgeType + args.edgeTrainType + str(args.edgeRenderWeight)
    cfg.edgeLoss = args.edgeLoss
    cfg.edgeType = args.edgeType
    cfg.edgeTrainType = args.edgeTrainType
    cfg.edgeRenderWeight = args.edgeRenderWeight
    # init enviroment
    ...
    if program == "export_bbox":
        ...
        PSNR = run_render(args=args, cfg=cfg, data_dict=data_dict, device=device)
    elif program == 'render':
    ...
    print(f"{cfg.expname}-PSNR,{PSNR}", file=open("result.csv", "a"))